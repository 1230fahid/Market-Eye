        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LstmLayers = table.Column<int>(type: "int", nullable: false),
                    LstmNeurons = table.Column<int>(type: "int", nullable: false),
                    DenseLayers = table.Column<int>(type: "int", nullable: false),
                    DenseNeurons = table.Column<int>(type: "int", nullable: false),
                    Dropout = table.Column<double>(type: "float", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserStocks_StockDatas_StockId",
                        column: x => x.StockId,
                        principalTable: "StockDatas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
